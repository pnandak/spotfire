...
#                         Data Import
#######################################################################           
setwd("/Users/anaorte/Documents/ANAMARIA/2013-10/LISASummer/Rbasics ")
...
boxplot(povpct~ms,col=c("blue", "blue", "blue", "yellow", "yellow", "yellow"), main="Boxplot of povpct by Marital Status")           
