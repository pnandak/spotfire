...
##        Ning Wang, LISA Lead Collaborator
...
###National Mortality data, which consists of a subset of 11 of the 26 Current
###Population Survey (CPS) cohorts included in the full NLMS ###
NMD <- read.csv(file="C:/Users/FDI/Desktop/Rbasics/RSTATanalysis/pubfileb.csv",head=TRUE,sep=",")
summary(NMD)
age<-NMD[,2]
hist(age,freq=T) # histogram
boxplot(age) # boxplot
boxplot(age~sexf,col=rainbow(3)) # you can also use formula
