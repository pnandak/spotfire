...
model2 <- optim(b0.2, stepfunc2, method="BFGS", control=list(maxit=500),
  hessian=TRUE, YY=Y, XX2=X2, XX3=X3);

save(model2, file=".Rdata.assign1d");
...
model3 <- optim(b0.3, stepfunc3, method="BFGS", control=list(maxit=500),
  hessian=TRUE, YY=W, XX1=X1, XX2=X2, XX3=X3);

save(model2, model3, file=".Rdata.assign1d");
