...
#        seed option.  The Levene and Breusch-Pagan test can be      #
...
examine.mod.simple<-function(mod.fit.obj, seed = 9180, const.var.test = FALSE, X = NULL, Y = NULL, boxcox.find = FALSE) {
