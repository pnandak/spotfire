############################################################################
# NAME:  Chris Bilder                                                      #
# DATE:  12-20-03, 12-10-05, 12-4-06, 12-20-06                             #
...
#Read in the data
gpa<-read.table(file = "C:\\chris\\UNL\\STAT_time_series\\day1\\gpa.txt", 
                header=TRUE, sep = "")
...
library(RODBC)
z<-odbcConnectExcel("C:\\chris\\UNL\\STAT_time_series\\day1\\gpa.xls")
