...
###################################################
### chunk number 27: interactive plotting using identify eval=FALSE
###################################################
## attach(ChickWeight)
## plot(Time, weight)
...
###################################################
### chunk number 28: The par function
###################################################
...
###################################################
### chunk number 29: Passing par parameter to a plot
###################################################
plot(1:20, rnorm(20), pch='+')


###################################################
### chunk number 30: Graphical elements using pch and text
###################################################
...
###################################################
### chunk number 34: inbuilt color palettes eval=FALSE
###################################################
## example(rainbow)


###################################################
### chunk number 35: Create a pdf of colors
###################################################
 source("http://research.stowers-institute.org/efg/R/Color/Chart/ColorChart.R")


###################################################
### chunk number 36: RColorBrewer eval=FALSE
###################################################
...
###################################################
### chunk number 38: Example on volcano dataset
###################################################
par(mfrow=c(2, 2))
...
###################################################
### chunk number 40: Lattice xyplot eval=FALSE
###################################################
## library(lattice)
...
###################################################
### chunk number 41: LatticeSimplexyplot
###################################################
library(lattice)
print(xyplot(weight~Time | Diet, data=ChickWeight)) 


###################################################
### chunk number 42: Lattice More xyplot eval=FALSE
###################################################
...
###################################################
### chunk number 43: LatticeMorexyplot
###################################################
print(xyplot(weight~Time|Diet,
       data=ChickWeight,
       panel=panel.superpose,
       groups=Chick,
       type='b'))
...
###################################################
### chunk number 44: latticeBarchart
###################################################
x <- 1:10
y <- 1:10
g <- factor(1:10)
...
###################################################
### chunk number 45: latticeBarchart
###################################################
print(barchart(y~g|1))
