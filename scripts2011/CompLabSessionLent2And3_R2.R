# -------------------------------------------------------------------
# Master in Finance Econometrics II Module
# Thilo Klein
# Lab Sessions 2&3: ARIMA, ARCH and GARCH Models
...
# test for autocorrelation up to lag 4 in squared residuals.
 ...
 ArchTest(sgarch.fit@fit$resid/sgarch.fit@fit$sigma , lags=4)
...
# of the squared residual).
 ...
 par(mfrow=c(2,1))
 acf(lm7$resid^2); pacf(lm7$resid^2) 
