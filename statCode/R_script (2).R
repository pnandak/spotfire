...
##Frank Farach & Xiaoxian Luo
##Social Sciences Statistical Laboratory, Yale University
##2006-10-20

##NOTE: We will be cutting and pasting these commands one at a time to demonstrate
...
?help		# Same as above
apropos(help)	# Find all functions that include the word 'help'

# Reading in your data
getwd()		# What directory are we in?
setwd("I:\\2006_Fall\\R_Intro")	# Set working directory to the directory where we put the data	
...
mod3.1 <- lm(remote ~ weight + gender, qr=T)	# Gives you regression diagnostics
